...
public class App {
    public static void main(String[] args) {
        ...
        Configuration.init("chatebote");
        ArgumentHandler argsHandler = new ArgumentHandlerBuilder()
                .setGui(new GUI_Service())
                .setTui(new TUI_Service())
                .setSingleGui(new SINGLE_GUI_Service())
                .setSingleTui(new SINGLE_TUI_Service(args))
                .build();

        argsHandler.handle(args, messageService);
    }
}
